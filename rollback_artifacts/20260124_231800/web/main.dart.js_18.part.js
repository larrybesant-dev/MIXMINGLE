...
$__dart_deferred_initializers__.current = function (a, b, c, $) {
  ...
  C.zN.prototype = {
    h3(d, e) {
      ...
      return A.cO(
        ...
        A.lk(
          new C.aKK(),
          A.eW(new A.bJ(r)).af("withdrawals").ew(0, "userId", x.a.c.a.a).f3("createdAt", !0).eA(),
          y.g,
        ),
        u,
        u,
  ...
  C.aKJ.prototype = {
    $2(d, e) {
      ...
      s = A.b(
        [
          A.B("Email: " + v, r, r, r, r, r, r, r, r),
          A.B("Status: " + x.toUpperCase(), r, r, r, r, r, r, r, r),
        ],
        y.e,
      );
      if (u != null)
        s.push(A.B("Date: " + B.c.al(A.f7(u.geQ()).l(0), 0, 10), r, r, r, r, r, r, r, r));
      return A.h2(
        A.h8(
          !1,
          r,
...
((a) => {
  a["8lbBxOU3RscgZo3/2W9t1Q8Z+R8="] = a.current;
