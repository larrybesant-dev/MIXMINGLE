...
void main() {
  group('Chat & Reactions Network Chaos', () {
    testWidgets('Messages queue and flush correctly under latency', (tester) async {
      final harness = NetworkDegradationHarness(minLatencyMs: 200, maxLatencyMs: 1500, logger: print);
    ...
    testWidgets('No duplicate or lost reactions under packet loss', (tester) async {
      final harness = NetworkDegradationHarness(packetLossRate: 0.4, logger: print);
      await harness.runWithConditions(() async {
