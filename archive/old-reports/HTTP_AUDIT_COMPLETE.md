...
- ✅ `http.get(...)` — No matches in lib/**/*.dart
- ✅ `http.post(...)` — No matches in lib/**/*.dart
- ✅ `http.Client()` — No matches in lib/**/*.dart
- ✅ `package:http` imports — No matches in lib/**/*.dart
- ✅ `cloudfunctions.net` URLs — No matches in lib/**/*.dart
- ✅ `Uri.parse("...cloudfunctions...")` — No matches in lib/**/*.dart
- ✅ Manual `Authorization: Bearer` headers — No matches in lib/**/*.dart
