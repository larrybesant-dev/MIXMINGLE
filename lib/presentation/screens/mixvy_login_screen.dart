                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(child: Divider(color: const Color(0xFF262626))),
                          Padding(
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              style: OutlinedButton.styleFrom(
                                ...
                                side: const BorderSide(color: Color(0xFF484847), width: 1),
                          ...
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              label: Text('Apple', style: GoogleFonts.inter(color: Colors.white)),
                              style: OutlinedButton.styleFrom(
                                backgroundColor: const Color(0xFF20201f),
                                side: const BorderSide(color: Color(0xFF484847), width: 1),
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
                      ...
                      Center(
                        child: Text.rich(
                          TextSpan(
                            ...
                            style: GoogleFonts.inter(color: const Color(0xFFadaaaa)),
                            children: [
                              TextSpan(
                                text: 'Create One',
                                style: GoogleFonts.inter(
