...
class AgoraMobileEngine implements IVideoEngine {
  ...
  Future<void> initialize(String appId) async {
    ...
    try {
      ...
      _setupEventHandlers();
      _initialized = true;
      debugPrint('[AGORA_MOBILE] âœ… Initialization complete');
    } catch (e) {
  ...
  Future<void> joinChannel({
    ...
    try {
      ...
      debugPrint('[AGORA_MOBILE] âœ… Joined channel');
    } catch (e) {
  ...
  Future<void> leaveChannel() async {
    ...
    try {
      ...
      debugPrint('[AGORA_MOBILE] âœ… Left channel');
    } catch (e) {
  ...
  Future<void> enableLocalTracks({
    ...
    try {
      ...
      debugPrint('[AGORA_MOBILE] âœ… Local tracks updated');
    } catch (e) {
  ...
  Future<void> setAudioMuted(bool muted) async {
    ...
    try {
      ...
      debugPrint('[AGORA_MOBILE] âœ… Audio mute state: $muted');
    } catch (e) {
  ...
  Future<void> setVideoMuted(bool muted) async {
    ...
    try {
      ...
      debugPrint('[AGORA_MOBILE] âœ… Video mute state: $muted');
    } catch (e) {
  ...
  Future<void> muteRemoteAudio(int remoteUid, bool muted) async {
    ...
    try {
      ...
      debugPrint('[AGORA_MOBILE] âœ… Remote audio muted');
    } catch (e) {
  ...
  Future<void> muteRemoteVideo(int remoteUid, bool muted) async {
    ...
    try {
      ...
      debugPrint('[AGORA_MOBILE] âœ… Remote video muted');
    } catch (e) {
