...
class WebRtcRoomService implements RtcRoomService {
  ...
  @override bool get canRenderLocalView => _unsupported();
  ...
  @override bool get isLocalAudioMuted => _unsupported();
  ...
  @override Future<void> initialize(String appId) => _unsupported();
  ...
  @override Future<void> mute(bool muted) => _unsupported();

  @override Future<void> setBroadcaster(bool enabled) => _unsupported();

  @override Future<void> publishLocalVideoStream(bool enabled) => _unsupported();

  @override Future<void> publishLocalAudioStream(bool enabled) => _unsupported();
