            ...
            _statusPill(
              ...
              _dmColor(p.dmRestriction),
                    ...
                    _statusPill(
                      ...
                      p.hideDistance == true ? 'Distance Hidden' : 'Distance Visible',
                      p.hideDistance == true ? const Color(0xFF00C853) : const Color(0xFF6B7280),
                    ),
                    _statusPill(
                      Icons.visibility_off_outlined,
                      p.hideFollowers == true ? 'Followers Hidden' : 'Followers Visible',
                      p.hideFollowers == true ? const Color(0xFF00C853) : const Color(0xFF6B7280),
                    ),
                    _statusPill(
                      Icons.do_not_disturb_outlined,
                      p.restrictRoomInvites == true ? 'Invites Restricted' : 'Invites Open',
                      p.restrictRoomInvites == true ? const Color(0xFF00C853) : const Color(0xFF6B7280),
                    ),
            _statusPill(
              Icons.lock_outlined,
