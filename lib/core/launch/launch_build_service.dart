...
''';
  ...
  Future<FlavorVerificationResult> verifyFlavors() async {
    try {
      ...
      final androidGradlePath = 'android/app/build.gradle';
      ...
      final iosSchemesPath = 'ios/Runner.xcodeproj/xcshareddata/xcschemes';
  ...
  Future<IconVerificationResult> verifyIcons() async {
    try {
      ...
      // Check Android icons
      final androidResPath = 'android/app/src/main/res';
      ...
      // Check iOS icons
      final iosIconPath = 'ios/Runner/Assets.xcassets/AppIcon.appiconset';
  ...
  Future<SplashVerificationResult> verifySplash() async {
    try {
      ...
      final androidSplashPath = 'android/app/src/main/res/drawable/launch_background.xml';
      ...
      final iosSplashPath = 'ios/Runner/Base.lproj/LaunchScreen.storyboard';
  ...
  Future<PrivacyManifestResult> verifyPrivacyManifests() async {
    try {
      ...
      final privacyManifestPath = 'ios/Runner/PrivacyInfo.xcprivacy';
