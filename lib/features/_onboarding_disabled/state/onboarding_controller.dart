...
// TEMP DISABLED: import '../../../core/engagement/onboarding_optimization_service.dart';
...
class OnboardingController extends ChangeNotifier {
    ...
    try {
      ...
      if (userId != null && userName != null) {
        ...
        if (welcomeRoomId != null) {
          debugPrint('âœ… Auto-joined welcome room: $welcomeRoomId');
        }
      }
  ...
  static Future<void> resetOnboarding() async {
    try {
      ...
      debugPrint('ðŸ”„ Onboarding reset');
    } catch (e) {
