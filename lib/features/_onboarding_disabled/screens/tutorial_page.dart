          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: [
                  card.color.withValues(alpha: 255, red: 255, green: 255, blue: 255),
                  Colors.transparent,
                ],
              ),
              boxShadow: [
                BoxShadow(
                  color: card.color.withValues(alpha: 255, red: 255, green: 255, blue: 255),
                  blurRadius: 40,
                  spreadRadius: 10,
                ),
              ],
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        color: isActive
            ...
            : DesignColors.white.withValues(alpha: 255, red: 255, green: 255, blue: 255),
        boxShadow: isActive
            ? [
                BoxShadow(
                  color: _cards[_currentPage].color.withValues(alpha: 255, red: 255, green: 255, blue: 255),
                  blurRadius: 8,
                  spreadRadius: 2,
                ),
              ]
